...
/**
 * Responsabili d'area — sezione a sé, fra il Board e le aree.
 *
 * Prima era il secondo blocco della sezione Team. Sta meglio qui: dopo
 * il Board si legge come il livello successivo dell'organigramma, e
 * apre alla sezione delle aree che segue. La sezione Team resta su un
 * solo tema, le aree.
 *
