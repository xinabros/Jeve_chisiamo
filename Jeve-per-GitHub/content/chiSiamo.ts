...
export const sections = {
  ...
  /* La sezione Team ha un blocco solo, le aree, con la sua testatina.
     Chi le guida sta in una sezione a parte (`leads`), che nell'ordine
     della pagina viene prima. */
  areas: {
  ...
  /* Sezione a sé, fra l'organigramma e le aree: i cinque Responsabili in
     griglia. (Non è più "in coda al mosaico delle aree" come diceva
     questa riga: quel blocco è diventato una sezione, e nell'ordine
     attuale viene prima delle aree, non dopo.) */
  leads: {
