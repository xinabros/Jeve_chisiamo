...
export const sections = {
  ...
  alumni: {
    ...
    /* Alternative pronte: "Le testimonianze dei nostri Alumni" ·
       "Dove sono arrivati" · "Chi è passato di qui".
       ⚑ "Dicono di noi" NO: si sovrapporrebbe al titolo del riquadro
       rosso qui sotto, che dice già "Cosa dicono di noi". */
    ...
    /* Intitola il riquadro rosso accanto al carosello. Sta su una
       misura stretta (20ch), quindi va a capo: tienilo corto. */
    voices: {
