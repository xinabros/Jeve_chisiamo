...
export const sections = {
  ...
  stats: {
    ...
    /* ⚑ TESTO NUOVO, da rivedere: intitola il riquadro rosso del
       carosello delle testimonianze, che prima non aveva
       un'intestazione propria. */
    voices: {
      kicker: "Recensioni",
      title: "L'opinione e la soddisfazione dei nostri clienti",
    },
  },
};
...
export const testimonials: Testimonial[] = [
  ...
  {
    quote:
      "«Citazione placeholder: il modo in cui il team ha affrontato un imprevisto, restando comunque nei tempi concordati e con un risultato oltre le aspettative.»",
    name: "«Nome Cognome»",
    role: "«Ruolo» · «Associazione»",
  },
];
