...
export const missionVision: {
  ...
  mission: {
    ...
    photoAlt: "«Descrizione della foto: persone al lavoro durante una riunione»",
  },
  ...
  vision: {
    ...
    photoAlt: "«Descrizione della foto: un momento di confronto fra i membri»",
  },
...
export const teamAreas: TeamArea[] = [
  {
    ...
    members: 8,
    people: [
      { name: "Pietro Gastaldon", level: "Responsabile" },
    ],
    href: "#",
  },
  {
    ...
    members: 7,
    people: [
      { name: "Giovanni Miotto", level: "Responsabile" },
  ...
  },
  {
    ...
    members: 4,
    people: [
      { name: "Eleonora Rizzato", level: "Responsabile" },
  ...
  },
  {
    ...
    members: 8,
    people: [
      { name: "Riccardo Mari", level: "Responsabile" },
  ...
  },
  {
    ...
    members: 9,
    people: [
      { name: "Luca Presti", level: "Responsabile" },
